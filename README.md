...
- [minimal-hud](https://github.com/vipexv/minimal-hud) - A Minimal HUD Built using Preact/Tailwind CSS, it's built to be standalone with optional support for ESX, QB, OX and allows for easy setup for a custom framework.
